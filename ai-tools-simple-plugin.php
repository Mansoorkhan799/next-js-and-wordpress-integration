<?php
/**
 * Plugin Name: AI Tools Platform - Simple Version
 * Plugin URI: https://yourwebsite.com
 * Description: Simple WordPress plugin for AI Tools platform integration with REST API enhancements
 * Version: 1.0.0
 * Author: Your Name
